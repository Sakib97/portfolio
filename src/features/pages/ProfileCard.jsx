            ...
            <div className="card border-0 shadow">
                ...
                <div className={`card-body p-1-9 p-xl-5 ${styles.centered}`}>
                        ...
                        <li className="mb-3">
                            <div className={styles.flexRow}>
                                <i
                                    ...
                                    style={{ fontSize: "1.3rem", color: "#3f59b7", marginRight: "8px", transform: "translateY(4px)" }}
                                ></i>
                                <a href="mailto: ashekseum86@gamil.com">ashekseum86@gamil.com</a>
                        ...
                        <li className="mb-3">
                            <div className={styles.flexRow}>
                                ...
                                <i
                                    ...
                                    style={{ fontSize: "1.3rem", color: "#3f59b7", marginRight: "5px" }}
                                ></i>
                                +88 01623247656
                            </div>
                        </li>
                    ...
                    <ul className={`${styles.socialList}`}>
                        <li>
                            <a href="https://github.com/Sakib97" className={styles.socialIcon}>
